...
if __name__ == '__main__':
    run()
reate template on dataflow with the comand line -> python template.py --runner DataflowRunner --project $PROJECT --staging_location gs://$BUCKET/staging --temp_location gs://$BUCKET/temp --
template_location gs://$BUCKET/templates/$TemplateName 
Execute template with dataflow jobs -> gcloud dataflow jobs run [NameJob] --gcs-location gs://$PROJECT/templates/global_options --parameters path=gs://feat-dataflow-pipeline/geo-sirene_82.csv --reg
ion=$REGION"""
